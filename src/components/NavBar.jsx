...
import BrushXIcon from "./icons/BrushXIcon"; // Added closing icon
...
const NavBar = () => {
  ...
  const navItems = [
    ...
    { name: "Their Stories", path: "/#theirStory" },
  ...
  return (
    <div className="w-[100vw] h-[53px] flex items-center justify-between px-5 py-4 fixed top-0 z-50 bg-[#FFFBFB59] backdrop-blur-md">
      {/* Logo */}
      <img
        alt="logo"
        src={logo}
